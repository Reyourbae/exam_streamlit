...
if test == "Columns":
    st.subheader("Hai, Sahabat Kelas Awan Pintar :wave:")
    st.write("Kita akan belajar di halaman ini mengunakan fungsi Coloum")
...
if test == "Tabs":
    ...
    # Pengambilan data
    gambar2 = Image.open('image/img1.png')
    gambar3 = Image.open('image/img2.png')
    gambar4 = Image.open('image/test1.jpg')
...
if test == "expander & container":
    ...
    gambar = Image.open('image/img1.png')
